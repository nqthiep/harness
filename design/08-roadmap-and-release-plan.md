...
3. **Ba mục kỹ thuật còn mở** (N-1/N-5/N-6/N-8 đã đóng), không mục nào chặn release —
   `07-risks-and-open-issues.md §7` liệt kê đầy đủ (`AuthEvidence` cho S-11, S-9's
   re-pointing MCP, N-3's LangGraph `returns=` parity).
